...
export default function DashboardPage() {
  ...
  return (
    // TODO: replace `"reports" as any` with `"dashboard"` once "dashboard" is added to NavKey in EnterpriseShell
    <EnterpriseShell
      active={"reports" as any} // eslint-disable-line @typescript-eslint/no-explicit-any
      title="Dashboard"

...
```
- **If output is non-empty** (any tracked or untracked changes exist):
  STOP. Do not modify, stash, or discard anything. Go to §3 "Hard stop:
  dirty tree" and exit the cycle.

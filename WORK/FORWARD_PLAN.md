...
| OpenAPI contract validation | ✅ **added 2026-08-06** — `contract:scan` (F-18), **gating** on phantom operations; undocumented-route count ratcheted report-only |

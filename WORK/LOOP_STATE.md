...
| API gap-scan guardrail | DONE (2026-07-18 — tools/api-gap-scan.mjs in CI hygiene job + npm run verify; allowlist board-tied, shrink-only; now down to 38 entries, was 56) | AUDIT_2026-07-18T005030Z addendum §6 |

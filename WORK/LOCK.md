...
| Status | **RELEASED** — pushed to `claude/supabase-connection-setup-v86psj`, PR #216 → `develop` (draft; a human marks it ready and merges, per `AGENTS.md`). Code fix is commit `a0b28d9`. |

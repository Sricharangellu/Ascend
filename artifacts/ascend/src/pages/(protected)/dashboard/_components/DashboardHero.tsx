...
export function DashboardHero() {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-brand-600/20 bg-gradient-to-br from-[#0A2540] to-brand-900 shadow-xl">
      ...
      <div className="relative flex flex-col items-start px-8 py-10 lg:px-12 lg:py-16 z-10">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-semibold tracking-wide text-brand-200 backdrop-blur-md mb-6 uppercase">
        ...
        <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-brand-100/80 sm:text-base">
          One platform to manage every aspect of your business—Purchasing • Inventory • Sales • Finance • Warehousing • Distribution • CRM • Analytics • AI.
        </p>

        <div className="mt-8 flex flex-wrap items-center gap-4">
          <Link href="/reports" className="inline-flex h-10 items-center justify-center rounded-lg bg-brand-500 px-6 text-[13px] font-semibold text-white shadow-md shadow-brand-500/20 transition-colors hover:bg-brand-400">
            Executive Dashboard
          </Link>
          <Link href="/settings" className="inline-flex h-10 items-center justify-center rounded-lg border border-white/20 bg-white/5 px-6 text-[13px] font-medium text-white backdrop-blur-sm transition-colors hover:bg-white/10 hover:border-white/30">
            Configuration
          </Link>
        </div>
      </div>

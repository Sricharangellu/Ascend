  ...
  return (
    <AuthShell>
      <div className="rounded-2xl border border-white/40 bg-white/80 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur-xl sm:p-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold" style={{ color: "var(--color-text-primary)" }}>Sign in</h2>
        ...
        <form onSubmit={handleSubmit} noValidate aria-label="Sign in form" className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className={`min-h-[44px] w-full rounded-lg border bg-white/90 px-3 text-base outline-none transition-colors placeholder:text-[var(--color-text-muted)] disabled:cursor-not-allowed disabled:opacity-60 ${
                emailError
                  ? "border-danger-500 focus:border-danger-500 focus:ring-2 focus:ring-danger-500"
                  : "border-[var(--color-border)] focus:border-brand-500 focus:ring-2 focus:ring-brand-500"
              }`}
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="relative flex items-center">
              <input
                ...
                className={`min-h-[44px] w-full rounded-lg border bg-white/90 px-3 pr-11 text-base outline-none transition-colors placeholder:text-[var(--color-text-muted)] disabled:cursor-not-allowed disabled:opacity-60 ${
                  passwordError
                    ? "border-danger-500 focus:border-danger-500 focus:ring-2 focus:ring-danger-500"
                    : "border-[var(--color-border)] focus:border-brand-500 focus:ring-2 focus:ring-brand-500"
                }`}
              ...
              <button
                ...
                className="absolute right-2 flex h-9 w-9 items-center justify-center rounded-md focus-visible:ring-2 focus-visible:ring-brand-600"
          ...
          <label className="flex items-center gap-2 text-sm" style={{ color: "var(--color-text-secondary)" }}>
            <input
              ...
              className="h-4 w-4 rounded text-brand-600 focus:ring-2 focus:ring-brand-500"
          ...
          {mfaPendingToken && (
            <div className="flex flex-col gap-1">
              <label htmlFor="mfa-code" className="text-sm font-medium" style={{ color: "var(--color-text-secondary)" }}>
                Authentication code
                <span className="ml-1 text-danger-600" aria-hidden="true">*</span>
                <span className="sr-only">(required)</span>
              </label>
              <input
                ...
                className="min-h-[44px] w-full rounded-lg border bg-white/90 px-3 text-base outline-none transition-colors placeholder:text-[var(--color-text-muted)] focus:border-brand-500 focus:ring-2 focus:ring-brand-500 disabled:cursor-not-allowed disabled:opacity-60"
        ...
        <p className="mt-6 text-center text-sm" style={{ color: "var(--color-text-muted)" }}>
          ...
          <Link href="/signup" className="font-semibold hover:underline" style={{ color: "var(--color-text-primary)" }}>
            Create one free
          </Link>
        </p>
      </div>
      ...
      <p className="mt-4 flex items-center justify-center gap-2 text-center text-xs" style={{ color: "var(--color-text-muted)" }}>
        <LockIcon />
...
function LoginCardSkeleton() {
  return (
    <div
      ...
      className="rounded-2xl border border-white/40 bg-white/80 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur-xl sm:p-8"
    >

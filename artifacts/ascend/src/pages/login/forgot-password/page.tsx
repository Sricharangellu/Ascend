      ...
      <div className="rounded-2xl border border-white/40 bg-white/80 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur-xl sm:p-8">
        {sent ? (
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 text-2xl font-bold" style={{ color: "var(--color-text-primary)" }}>Check your email</h2>
            <p className="mt-2 text-sm" style={{ color: "var(--color-text-muted)" }}>
              If an account exists for <span className="font-medium" style={{ color: "var(--color-text-secondary)" }}>{email}</span>, we&apos;ve
          ...
          <>
            <div className="mb-6">
              <h2 className="text-2xl font-bold" style={{ color: "var(--color-text-primary)" }}>Reset your password</h2>
